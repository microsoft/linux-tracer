...
case $1 in
		...
		-h) 
			...
			echo "		This option is used for short time captures"
		    echo "            ./linux_cpu_tracer_v2.sh -l <nr. of samples> <wait time in seconds>."
			echo "		Collect N samples with X seconds interval."
			echo "		To be used with 'nohup' and sent to background: nohup './linux_cpu_tracer_v2.sh -l 24 3600 &'"
		;;
